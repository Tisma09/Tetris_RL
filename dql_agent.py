...
class DQLAgent:
    def __init__(self, state_size, action_size, filename=None, loading=False, epsilon=1.0, epsilon_min=0.01, epsilon_decay=0.995, gamma=0.99, learning_rate=0.001, batch_size=32, max_memory=2000):
